...
scplot(exampleA1B1A2B2) %>% 
  ...
  add_grid(color = "grey85", size = rel(0.5)) %>%
  set_dataline(color = "black", width = rel(1), linetype = "solid", 
               dots = "sienna4", size = rel(1), shape = 18) %>%
