...
scplot(example_A24) %>% 
  ...
  set_phasenames("no speedlimit", "with speedlimit", x = "centre", y = "top", size = 0.8, box = "white") %>%
  set_casenames("") %>%
  add_title("Effect of a speedlimit on the A24") %>%
  add_grid(color = "white", width = 1.5, type = "solid") %>%
...
scplot(exampleAB_add) %>%
  ...
  add_statline("trend", type = "dashed") %>%
